...
| [13]{style="color: #C138A0;"}  | [Exploration]{style="color: #C138A0;"}     | [How to explore in complex scenarios]{style="color: #C138A0;"} | 
|      | **Model-Based Control**                                   |                                     |
|      | **Advanced Topics**                                       |                                     |
...
::: fragment
::: footer
$\textcolor{green}{\mathbf{+}\text{ No change to original reward function}}\quad\mathRed{\mathbf{-}\text{ Good bonuses often do better.}}$
:::
:::
